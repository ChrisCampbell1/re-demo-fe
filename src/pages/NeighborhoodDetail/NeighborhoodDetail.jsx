  ...
  if (neighborhood) {
    return (
      <main className={styles.container}>
        <Helmet>
          <title>{`${neighborhood.name} Real Estate`}</title>
          <link rel="canonical" href={`/${slug}`} />
          <meta name='description' content={neighborhood.about.slice(0, 170)} />
          <meta property='og:title' content={neighborhood.name} />
          <meta property='og:description' content={neighborhood.about.slice(0, 170)} />
          <meta property='og:image' content={neighborhood.hero} />
        </Helmet>
